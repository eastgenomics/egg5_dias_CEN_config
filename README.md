...
| app | eggd_GATKgCNV_call | **eggd_GATKgCNV_call_v2.0.1** | `app-J2gK76Q4FqqkPxZBkJYBj632` | **eggd_GATKgCNV_call_v2.0.0** | `app-GvZB5p846Vg69fBg0Fq10938` |
...
| config | cen_vep_config for SNV/mosaic reports | **cen_vep_config_GRCh38_v1.1.6.json** | `file-J429BY04z6jBb2bp1GgJv4K1` | **cen_vep_config_v1.2.1.json** | `file-J04Kfv04z6j02Jz1Zj9VvK7k` |
